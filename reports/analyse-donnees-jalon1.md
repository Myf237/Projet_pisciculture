...
- **ADR-003 — ammoniac.** 33,18 % des valeurs non manquantes (27 560 / 83 074) sont > 5 et forment un plateau de valeurs strictement identiques à 4,27 × 10¹¹ (code d'erreur probable, comme le -127 °C de la température). Après exclusion de ces valeurs, la partie restante (55 514 valeurs, 66,82 %) a une distribution resserrée et plausible : min 0,00677, médiane 0,458, p99 4,497, max 4,982 — voir §4.
...
- **Valeurs extrêmes :** 27 560 relevés non manquants (33,18 % des 83 074 valeurs non manquantes) dépassent 5. Les 20 valeurs les plus extrêmes examinées sont **toutes identiques à 4,27 × 10¹¹** — pas une distribution continue qui s'étalerait naturellement vers de grandes valeurs, mais une valeur unique répétée, du même type que le code d'erreur -127 identifié sur la température (docs/01, anomalie 1). Répartition par seuil :
