...
@pytest.mark.skip(reason="Jalon 2 — distance au seuil critique calculée par paramètre, seuil non tranché (None) laissé de côté (docs/02 §3, docs/03)")
def test_add_threshold_distance_computes_signed_gap_per_parameter() -> None:
    """add_threshold_distance ajoute un écart signé au seuil critique le plus proche pour chaque paramètre défini."""
